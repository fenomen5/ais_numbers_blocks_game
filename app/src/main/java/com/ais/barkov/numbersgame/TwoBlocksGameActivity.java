...
public class TwoBlocksGameActivity extends AppCompatActivity {

    private static final int BLOCKS_NUMBER = 2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_two_blocks_game);

        this.initGame();
        //((TextView)findViewById(R.id.txtCurrentRule)).setText(rule);

        //Toast.makeText(this,rule.getClass().getName(),Toast.LENGTH_LONG);
